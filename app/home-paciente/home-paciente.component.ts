...
export class HomePacienteComponent implements OnInit {
  ...
  //função para redirecionar para a tela do prontuário já cadastrado
  redirectProntuarioCadastrado(){
    this.sharedService.redirectProntuarioCadastrado();
  }

  //função para redirecionar para a tela da receita já cadastrada
  redirectReceitaCadastrada(){
    this.sharedService.redirectReceitaCadastrada();
  }
